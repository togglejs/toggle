    ...
    function gulpPlugin(site) {
        ...
        var stream = through.obj(function (file, enc, callback) {
            ...
            if (file.isBuffer()) {
                ...
                metadata._rawDate = metadata.date;
                ...
                if (metadata.layout === "post") {
                    file.path = getBlogOutputname(moment(metadata._rawDate), file.path, site.blogSlugFormat);
...
bulp.templatesHelper = require('./bulp-handlebars.js');
bulp.renderSeries = require('./bulp-renderSeries.js');
bulp.description = require('./bulp-description.js');
