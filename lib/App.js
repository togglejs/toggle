...
module.exports = function (opts) {
    ...
    var defaults = {
        ...
        author: "(TODO put your name ex: Bugs Bunny)",
    ...
    //defaults.addFile = defaults.addPost;
    ...
    var Post = function (site, opts) {
        ...
        Post.prototype = _.create(site, {
            ...
            page_header: true,
            page_meta: true,
            _date: "TODO (put a date in the format of YYYY-MM-DD in the YAML frontmatter of your post. EX: 'date: 2014-01-22')",
            sharing: true,
        });
        ...
        Object.defineProperty(Post.prototype, "date", {
            ...
            //    } else {
            //        console.error('ERROR: could not parse date [' + JSON.stringify(value) + '] with http://momentjs.com/.');
            //    }
            //},
            enumerable: true,
            configurable: true
        ...
        Object.defineProperty(Post.prototype, "categories", {
            ...
            set: function (values) {
                if (Array.isArray(values)) {
                    ...
                    var slugFormat = this.categoriesSlugFormat || "[ERROR: no categoriesSlugFormat? huh?]";
